...
Верни JSON: {"action_type":"create_checklist_item","card_id":null,"checklist_name":"Шаги","checklist_item":[...],"response_text":"..."}.
Если пользователь явно указал ссылку на карточку или 24-символьный id — занеси его в card_id.
Если нет — оставь card_id null, сервер уточнит у пользователя.
""",
